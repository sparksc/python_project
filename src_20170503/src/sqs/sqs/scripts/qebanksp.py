...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql =u"""SELECT c.ID, c.ETL_DATE, c.ORG_NO, d.ORG0_NAME, c.MANAGER_NO, s.SALE_NAME, c.CUST_NO, i.CUST_NAME, c.TYP,c.STATUS
    ...
    def column_header(self):
        return []
        #return ["编号","维护日期","机构编号","机构名称","员工号","员工名称","公私标志","客户号","客户名","类型","分配比例","管理起始日期","管理结束日期","状态"]
