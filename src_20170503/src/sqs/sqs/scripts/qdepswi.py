...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql =u"""SELECT c.ORG_NO, d.BRANCH_NAME, c.manager_no, s.name, c.ACCOUNT_NO,u.cust_long_no,u.CUST_NAME, c.percentage,c.note,follow_cust, c.ID 
                 ...
                 WHERE typ='存款' and follow_cust='客户号优先' and c.status='正常'and name is not null %s ORDER BY ID"""%(filterstr)
        print sql
    ...
    def column_header(self):
        return ["机构号","机构名","员工号","员工名","账号","客户号","客户名","占比(%)","地址信息","优先级"]
