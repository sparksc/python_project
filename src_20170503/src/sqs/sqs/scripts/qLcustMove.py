...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql1 =u"""
                select c.id,c.org_no,o.org0_name,c.manager_no,u.name,c.cust_no,i.cust_name,c.percentage,nvl(c.balance/100.00,0),nvl(c.add_avg_balance/100.00,0),c.note, c.cust_in_no
                from cust_hook c
                join f_user u on u.user_name=c.manager_no
                join d_org o on o.org0_code=c.org_no
