...
#        row = self.engine.execute(sql.encode('utf-8'),vlist).fetchall()
    ...
    def column_header(self):
        return ["统计日期","机构号","机构名称","员工号","员工姓名","基础保底工资","基础业务量绩效薪酬","计件业务量绩效薪酬","业务量绩效薪酬","电银替代率绩效薪酬","附行式ATM业务量绩效薪酬","优质服务绩效薪酬","公共存款二次分配绩效薪酬","新增个人网银活跃客户绩效薪酬","新增手机银行活跃客户绩效薪酬","新增企业网银活跃客户绩效薪酬","新增丰收E支付有效客户绩效薪酬","新增POS机绩效薪酬","新增POS机活跃客户绩效薪酬","新增ETC活跃客户绩效薪酬","网银代发工资业务绩效薪酬","存款有效客户绩效薪酬","贷记卡绩效薪酬","有效烟草代扣户数绩效薪酬","有效一户通与支付宝卡通绩效薪酬","有效第三方存管绩效薪酬","单位结算户绩效薪酬","银村合作信用村绩效薪酬","社保卡激活绩效薪酬","黄金代理销售绩效薪酬","其他业务绩效薪酬","中间业务绩效薪酬合计值","日均自营存款存量绩效薪酬","日均自营存款增量绩效薪酬","绩效薪酬合计值"]
