...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql =u"""
                select es.SYEAR,es.ORG_CODE,b.BRANCH_NAME,es.USER_CODE,fu.NAME,es.online_home,es.online_buy,es.online_two,es.REMARKS,es.ID 
    ...
    def column_header(self):
        return ["年份","机构号","机构名称","员工号","员工名","丰收家上线家数","丰收购上线家数","两家上线家数","备注","操作"]
    @property
    def page_size(self):
        return 10
