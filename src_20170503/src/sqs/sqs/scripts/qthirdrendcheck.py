...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        self.filterlist = ['CUST_NO','NOTE','ORG_NO','CUST_NAME']
        filterstr,vlist = self.make_eq_filterstr()
        sql =u"""
                SELECT a.id, a.ORG_NO,o.branch_NAME, a.CUST_NO,c.CUST_NAME,a.NOTE
                FROM CUST_HOOK a
                JOIN D_CUST_INFO c ON c.cust_no=a.cust_in_no
                JOIN branch o ON a.ORG_NO=o.branch_code
    ...
    def column_header(self):
        return ["序号","机构号","机构名","客户号","客户名","地址信息"]
