...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        for i in row:
            t=list(i[0:7])
            #if t[5] not in ['行长(总经理)','副行长(主持)','副行长','行长助理']:
            #    continue
            sale_code=str(t[3])
    ...
    def column_header(self):
        return [u"统计日期",u"机构编号",u"机构名称",u"员工编号",u"员工姓名",u"岗位名称",u"用工性质",u"基本工资",u"职位工资",u"业务经营考核效酬",u"综合效酬",u"劳动竞赛效酬",u"临时性资金组织效酬",u"安全防范效酬",u"全面风险管理效酬",u"不良贷款专项清收效酬",u"FTP绩效考核效酬",u"柜面渠道入口营销专项竞赛效酬",u"其他专项效酬1",u"其他专项效酬2",u"其他专项效酬3",u"其他专项效酬4",u"其他专项效酬5",u"其他效酬1",u"其他效酬2",u"其他效酬3",u"其他效酬4",u"其他效酬5",u"合计",u"操作"]
