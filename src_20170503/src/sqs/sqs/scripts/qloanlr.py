...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql =u"""SELECT c.ORG_NO, d.branch_NAME,c.manager_no, u.NAME, c.CUST_NO, i.CUST_NAME,c.percentage,c.note,c.STATUS,c.src,c.id
                 ...
                 WHERE 1=1 and c.status in ('正常') %s  
                 """%(filterstr)
        print sql
    ...
    def column_header(self):
        return ["机构号","机构名","员工号","员工名","客户号","客户名","占比(%)","地址信息","状态","是否补录","操作"]
