...
class Query(ObjectQuery):
    ...
    def prepare_object(self):
        ...
        sql =u"""SELECT c.ORG_NO, d.BRANCH_NAME, c.manager_no, s.name, c.CUST_NO, i.CUST_NAME, NOTE, c.ID 
                 ...
                 WHERE typ='第三方存管' and status in ('正常','已审批','预提交审批','待审批') %s ORDER BY ID"""%(filterstr)
        print sql
