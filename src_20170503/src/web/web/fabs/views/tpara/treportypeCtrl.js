/**
 * treportype Controller
 */
function treportypeController($scope,$rootScope, $filter, SqsReportService,tparaService,permissionService) {
...
treportypeController.$inject = ['$scope','$rootScope', '$filter', 'SqsReportService','tparaService','permissionService'];

angular.module('YSP').service('treportypeController', treportypeController);
