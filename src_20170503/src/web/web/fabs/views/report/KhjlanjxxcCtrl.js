/**
 * Khjlanjxxc Controller
 */
function KhjlanjxxcController($scope, $filter,SqsReportService,store,branchmanageService,depappointService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search(){
        ...
        SqsReportService.info('pmanagerypcheck', params).success(function(resp) {
            $scope.data = resp;
...
KhjlanjxxcController.$inject = ['$scope', '$filter', 'SqsReportService','store','branchmanageService','depappointService'];

angular.module('YSP').service('KhjlanjxxcController', KhjlanjxxcController);
