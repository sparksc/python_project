 ...
 * Ygajjxxc Controller
 */
function YgajjxxcController($scope, $filter, SqsReportService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search() {
        ...
        SqsReportService.info('empquarterlysalary', params).success(function(resp) {
            $scope.data = resp;
...
YgajjxxcController.$inject = ['$scope', '$filter', 'SqsReportService','branchmanageService'];

angular.module('YSP').service('YgajjxxcController', YgajjxxcController);
