 ...
 * Ygjbxc Controller
 */
function YgjbxcController($scope, $filter, SqsReportService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search() {
        ...
        console.log(params)
        SqsReportService.info('empbasicsalary', params).success(function(resp) {
            $scope.data = resp;
...
YgjbxcController.$inject = ['$scope', '$filter', 'SqsReportService','branchmanageService'];

angular.module('YSP').service('YgjbxcController', YgjbxcController);
