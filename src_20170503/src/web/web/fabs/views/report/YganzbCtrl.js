 ...
 * Yganzb Controller
 */
function YganzbController($scope, $filter, SqsReportService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search() {
        ...
        SqsReportService.info('empannualindex', params).success(function(resp) {
            $scope.data = resp;
...
YganzbController.$inject = ['$scope', '$filter', 'SqsReportService','branchmanageService'];

angular.module('YSP').service('YganzbController', YganzbController);
