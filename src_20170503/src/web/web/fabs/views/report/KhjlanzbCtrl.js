 ...
 * Khjlanzb Controller
 */
function KhjlanzbController($scope, $filter, SqsReportService,store,branchmanageService,depappointService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search(){
        ...
        SqsReportService.info('pmanagerycheck', params).success(function(resp) {
            $scope.data = resp;
...
KhjlanzbController.$inject = ['$scope', '$filter', 'SqsReportService','store','branchmanageService','depappointService'];
angular.module('YSP').service('KhjlanzbController', KhjlanzbController);
