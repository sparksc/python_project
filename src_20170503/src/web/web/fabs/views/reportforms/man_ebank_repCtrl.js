/**
 * man_ebank_rep Controller
 */
function man_ebank_repController($scope, $filter, SqsReportService,store,branchmanageService,depappointService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    function do_search(){
        ...
        SqsReportService.info('pmanagermcheck', params).success(function(resp) {
            $scope.data = resp;
...
man_ebank_repController.$inject = ['$scope', '$filter', 'SqsReportService','store','branchmanageService','depappointService'];

angular.module('YSP').service('man_ebank_repController', man_ebank_repController);
