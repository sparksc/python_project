/**
 * manaddsco Controller
 */
function manaddscoController($scope,store, $filter, $rootScope, SqsReportService,manscoinputService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    $scope.add = function(){
    $scope.newstaffdata={};
    $('#manaddsco_modal').modal('show');
    $('#manaddsco_new_add_button').show();
    $('#manaddsco_save_edit_button').hide();
    };
    ...
    $scope.save = function(){
        ...
        $scope.search(); 
        $('#manaddsco_modal').modal('hide');
        });
    };
    $scope.to_edit = function(row){
    $('#manaddsco_modal').modal('show');
    $('#manaddsco_new_add_button').hide();
    $('#manaddsco_save_edit_button').show();
...
manaddscoController.$inject = ['$scope','store', '$filter', '$rootScope', 'SqsReportService','manscoinputService','branchmanageService'];

angular.module('YSP').service('manaddscoController', manaddscoController);
