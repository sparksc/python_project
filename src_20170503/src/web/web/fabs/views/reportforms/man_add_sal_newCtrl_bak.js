 ...
 */
function manaddsalnewController($scope,store, $filter, $rootScope, SqsReportService,manscoinputService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    $scope.excelurl = rpt_base_url + "/report_proxy/sqs/man_add_sal_new?export=1"+"&login_branch_no=" + $rootScope.user_session.branch_code + "&login_teller_no=" + $rootScope.user_session.user_code;
...
manaddsalnewController.$inject = ['$scope','store', '$filter', '$rootScope', 'SqsReportService','manscoinputService','branchmanageService'];
