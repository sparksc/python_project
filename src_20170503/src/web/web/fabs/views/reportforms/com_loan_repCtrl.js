...
function comloanyongjinController($scope, $filter, SqsReportService,store,branchmanageService,depappointService) {
    ...
    function do_search(){
        ...
        $scope.excelurl = rpt_base_url + "/report_proxy/sqs/com_loan?export=1a";
    ...
    $scope.excelurl = rpt_base_url + "/report_proxy/sqs/com_loan?export=1";
    $scope.excelurl = rpt_base_url + "/report_proxy/sqs/com_loan?export=1a"+"&tdate="+moment().format('YYYYMMDD');
};
