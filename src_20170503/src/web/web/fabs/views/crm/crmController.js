/**
 抽取crm数据
 */
ysp.controller("crmController",function ($scope,store, $filter, $rootScope, SqsReportService,branchmanageService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    $scope.cust_search = {};
    //$scope.excelurl = rpt_base_url + "/report_proxy/sqs/select_crm?export=1";
    ...
    $scope.excelurl = rpt_base_url + "/report_proxy/sqs/select_crm?export=1"+ "&login_branch_no=" + $rootScope.user_session.branch_code + "&login_teller_no=" + $rootScope.user_session.user_code;
    ...
    $scope.search = function() {
        ...
        SqsReportService.info('select_crm', params).success(function(resp) {
