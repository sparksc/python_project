 ...
 * etc分配
 */
function etcfpController($scope, $rootScope, $filter, SqsReportService,branchmanageService,custHookMagService) {
    $scope.dict = {
        "first": "首页",
        "previous": "上一页",
        "next": "下一页",
    ...
    $scope.search = function() {
        ...
        SqsReportService.info('etcfp', params).success(function(resp) {
    ...
    var element1 = angular.element('#etcfpModal');
...
etcfpController.$inject = ['$scope', '$rootScope', '$filter', 'SqsReportService','branchmanageService','custHookMagService'];
angular.module('YSP').service('etcfpController', etcfpController);
