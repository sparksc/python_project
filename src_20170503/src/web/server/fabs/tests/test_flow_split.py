...
class TestInitDb(unittest.TestCase):
    ...
    def test_subbranch_flow(self):
        ...
        # 支行审贷小组审议			支行审贷小组
        user = self.session.query(User).filter_by(user_name="00779").first()
        self.process_approve_task(application_transaction, user)
    ...
    def process_approve_task(self,transaction,user):
        groups = []
        ...
        for t in task_list:
            ...
            if role and role in groups:
                t.user = user
                self.session.add(ApplicationComment(comment_type="同意",application=t.transaction.application \
                        , transaction_activity_id=t.transaction_activity_id \
                        , user=user))
                self.session.flush()
                t.active()
                # t.finish()
    ...
    def init_flow(self):
        ...
        # Lendingproposition
        lendingproposition_task = TaskActivity(activity_name=u"贷款申请",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='lendingproposition_task', waiting=True)
        self.session.add(lendingproposition_task)
        set_parameter(lendingproposition_task, u"角色", u"客户经理")


        chcproposition_task = TaskActivity(activity_name=u"转贷大表申请",activity_status=u'审议',  task_assign_module='fabs.workflow.default', task_assign_function='chcproposition_task', waiting=True)
        self.session.add(chcproposition_task)
        set_parameter(chcproposition_task, u"角色", u"客户经理")

        investigate_task = TaskActivity(activity_name=u"预审",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='investigate_task', waiting=True)
        self.session.add(investigate_task)
        set_parameter(investigate_task, u"角色", u"支行审查岗")

        write_report_task = TaskActivity(activity_name=u"撰写调查报告",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='write_report_task', waiting=True)
        self.session.add(write_report_task)
        set_parameter(write_report_task, u"角色", u"客户经理")

        # 并行
        subbranch_assessment_task = TaskActivity(activity_name=u"支行风险评价",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='subbranch_assessment_task', waiting=True)
        self.session.add(subbranch_assessment_task)
        set_parameter(subbranch_assessment_task, u"角色", u"支行风险评价岗")

        subbranch_review_task= TaskActivity(activity_name=u"支行审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='subbranch_review_task', waiting=True)
        self.session.add(subbranch_review_task)
        set_parameter(subbranch_review_task, u"角色", u"支行审查岗")


        subbranch_deliberation_task = TaskActivity(activity_name=u"支行审贷小组审议",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='subbranch_deliberation_task', waiting=True)
        self.session.add(subbranch_deliberation_task)
        set_parameter(subbranch_deliberation_task, u"角色", u"支行审贷小组")


        subbranch_president_task = TaskActivity(activity_name=u"支行长审议", activity_status=u'审议',task_assign_module='fabs.workflow.default', task_assign_function='subbranch_president_task', waiting=True)
        self.session.add(subbranch_president_task)
        set_parameter(subbranch_president_task, u"角色", u"支行行长")

        loan_application_task = TaskActivity(activity_name=u"放款申请",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='loan_application_task', waiting=True)
        self.session.add(loan_application_task)
        set_parameter(loan_application_task, u"角色", u"客户经理")

        subbranch_approve_task = TaskActivity(activity_name=u"支行长审批",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='subbranch_approve_task', waiting=True)
        self.session.add(subbranch_approve_task)
        set_parameter(subbranch_approve_task, u"角色", u"支行行长")

        credit_loan_task = TaskActivity(activity_name=u"放款", activity_status=u'审批结束',task_assign_module='fabs.workflow.default', task_assign_function='credit_loan_task', waiting=True)
        ...
        """
        # 并行
        ho_review_task = TaskActivity(activity_name=u"总行信贷审查", activity_status=u'审议',task_assign_module='fabs.workflow.default', task_assign_function='ho_review_task', waiting=True)
        self.session.add(ho_review_task)
        set_parameter(ho_review_task, u"角色", u"总行审查岗")

        ho_assessment_task = TaskActivity(activity_name=u"总行风险评价",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='ho_assessment_task', waiting=True)
        self.session.add(ho_assessment_task)
        set_parameter(ho_assessment_task, u"角色", u"总行风险评价岗")

        ho_riskowners_task= TaskActivity(activity_name=u"风险负责人审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='ho_riskowners_task', waiting=True)
        self.session.add(ho_riskowners_task)
        set_parameter(ho_riskowners_task, u"角色", u"总行风险负责人")


        riskowners_review_task = TaskActivity(activity_name=u"信贷负责人审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='riskowners_review_task', waiting=True)
        self.session.add(riskowners_review_task)
        set_parameter(riskowners_review_task, u"角色", u"总行审查负责人")

        riskowners_chairman_review_task = TaskActivity(activity_name=u"信贷负责人汇报董事长",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='riskowners_chairman_review_task', waiting=True)
        self.session.add(riskowners_chairman_review_task)
        set_parameter(riskowners_chairman_review_task, u"角色", u"总行审查负责人")

        bm_review_task = TaskActivity(activity_name=u"信贷分管行长审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='bm_review_task', waiting=True)
        self.session.add(bm_review_task)
        set_parameter(bm_review_task, u"角色", u"分管信贷副行长")

        committee_deliberation_task = TaskActivity(activity_name=u"总行信贷委员会审议",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='committee_deliberation_task', waiting=True)
        self.session.add(committee_deliberation_task)
        set_parameter(committee_deliberation_task, u"角色", u"总行审贷委")

        ho_president_task = TaskActivity(activity_name=u"总行行长审批",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='ho_president_task', waiting=True)
        self.session.add(ho_president_task)
        set_parameter(ho_president_task, u"角色", u"总行行长")

        subbranch_first_approve_task=TaskActivity(activity_name=u"支行行长预审批",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='subbranch_first_approve_task', waiting=True)
        self.session.add(subbranch_first_approve_task)
        set_parameter(subbranch_first_approve_task, u"角色", u"支行行长")

        ho_review_approve_task=TaskActivity(activity_name=u"信贷负责人审批",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='ho_review_approve_task', waiting=True)
        self.session.add(ho_review_approve_task)
        set_parameter(ho_review_approve_task, u"角色", u"总行审查负责人")

        ho_approve_task = TaskActivity(activity_name=u"总行行长终审",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='ho_approve_task', waiting=True)
        ...
        capital_riskowners_task=TaskActivity(activity_name=u"资金部负责人审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='capital_riskowners_task', waiting=True)
        ...
        lending_discount_task = TaskActivity(activity_name=u"贴现申请",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='lending_discount_task', waiting=True)
        self.session.add(lending_discount_task)
        set_parameter(lending_discount_task, u"角色", u"客户经理")

        discount_subbranch_review_task= TaskActivity(activity_name=u"贴现支行审查",activity_status=u'审议', task_assign_module='fabs.workflow.default', task_assign_function='discount_subbranch_review_task', waiting=True)
        self.session.add(discount_subbranch_review_task)
        set_parameter(discount_subbranch_review_task, u"角色", u"支行审查岗")

        discount_info_input= TaskActivity(activity_name=u"贴现信息录入",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='discount_info_input', waiting=True)
        self.session.add(discount_info_input)
        set_parameter(discount_info_input, u"角色", u"客户经理")

        check_ticket_task = TaskActivity(activity_name=u"贴现验票",activity_status=u'审批', task_assign_module='fabs.workflow.default', task_assign_function='check_ticket_task', waiting=True)
        ...
        flow4 = Flow(from_activity=write_report_task, to_activity=subbranch_assessment_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='credit_application_gurad')
        flow5 = Flow(from_activity=write_report_task, to_activity=subbranch_review_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='credit_application_gurad')
        #                    |
        #                    V
      ...
      #  flow24 = Flow(from_activity=ho_approve_task, to_activity=credit_loan_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='investigate_credit_application_gurad')
        ...
        self.session.add_all([flow1,flow2,flow3,flow4,flow5,flow6,flow7,flow8,flow9,flow10,flow11,flow12,flow13,flow14,flow15,flow16,flow17,flow18,flow19,flow20,flow21,flow22,flow23,flow30,flow180])
        ...
        # 资金负责人 -->分管行长
        flow37 = Flow(from_activity= capital_riskowners_task, to_activity=invest_bm_review_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='invest_application_gurad')
        #分管行长 --> 投资审议委员会
        flow38 = Flow(from_activity=invest_bm_review_task, to_activity=invest_deliberation_task, have_guard=False)

        #投资审议委员会--> 投资交易岗
        flow39 = Flow(from_activity=invest_deliberation_task, to_activity=invest_entering_task, have_guard=False)

        #客户经理提交给资金部负责人
        flow40 = Flow(from_activity=invest_entering_task, to_activity=finance_riskowners_approve_task, have_guard=False)

        #资金部负责人 --> 总行行长审批
        flow41 = Flow(from_activity=finance_riskowners_approve_task, to_activity=ho_approve_task, have_guard=False)
        #总行长 --> 投资交易岗
        flow42 = Flow(from_activity=ho_approve_task, to_activity=invest_data_check, have_guard=True,guard_module='fabs.workflow.default', guard_function='invest_application_gurad')

        self.session.add_all([flow31,flow32,flow33,flow34,flow35,flow36,flow37,flow38,flow39,flow40,flow41,flow42])
        ...
        #资金部风险岗审查->资金负责人
        flow203 = Flow(from_activity=bank_review_task, to_activity=capital_riskowners_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='bank_no_transfer_discount_application_gurad')
        ...
        flow206= Flow(from_activity=branch_transfer_discount_review_task, to_activity=capital_riskowners_task, have_guard=False)

        #资金部风险岗审查->同业分管行长审查
        flow207= Flow(from_activity=capital_riskowners_task, to_activity=bank_bm_review_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='bank_application_gurad')
        ...
        flow209= Flow(from_activity=bank_bm_review_task, to_activity=ho_approve_task, have_guard=True,guard_module='fabs.workflow.default', guard_function='bank_ho_amount_gurad')
        #总行长终审->同业交易岗
        flow210= Flow(from_activity=ho_approve_task, to_activity=bank_trade_data_check, have_guard=True,guard_module='fabs.workflow.default', guard_function='bank_application_gurad')

        self.session.add_all([flow201,flow202,flow203,flow204,flow205,flow206,flow207,flow208,flow209,flow210])
        ...
        #申请->贴现审查
        flow302 = Flow(from_activity=lending_discount_task, to_activity=discount_subbranch_review_task, have_guard=True, guard_module='fabs.workflow.default', guard_function='discount_application_no_quote_report')
        flow306 = Flow(from_activity=lending_discount_task, to_activity=discount_info_input, have_guard=True, guard_module='fabs.workflow.default', guard_function='discount_application_quote_report')
        #贴现审查->贴现信息录入
        flow303 = Flow(from_activity=discount_subbranch_review_task, to_activity=discount_info_input, have_guard=False)
        #随机客户经理验票
        #flow304 = Flow(from_activity=discount_info_input, to_activity=check_ticket_task, have_guard=False)
        flow305 = Flow(from_activity=discount_info_input, to_activity=subbranch_approve_task, have_guard=False)
        self.session.add_all([flow301,flow302,flow303,flow305])
        ...
        flow604 = Flow(from_activity=repossession_subbranch_president_task, to_activity=repossession_finance_charge_task, have_guard=False)
        flow605 = Flow(from_activity=repossession_subbranch_president_task, to_activity=repossession_ho_loan_charge_task, have_guard=False)
        #flow606 = Flow(from_activity=repossession_subbranch_president_task, to_activity=repossession_ho_riskowners_task, have_guard=False)
        ...
        self.session.add_all([flow601,flow602,flow603,flow604,flow605,flow607,flow608,flow609,flow610,flow611,flow612])
    ...
    def init_user_group(self):
        ...
        u1 = User(role_id=111,user_name=u'00530',name=u'王鑫'); f1 = Password(user=u1,algorithm=u'MD5',credential=u'qwe123')
        u2 = User(role_id=112,user_name=u'00511',name=u'王琛'); f2 = Password(user=u2,algorithm=u'MD5',credential=u'qwe123')
        u3 = User(role_id=113,user_name=u'00140',name=u'李建峰'); f3 = Password(user=u3,algorithm=u'MD5',credential=u'qwe123')
        u4 = User(role_id=114,user_name=u'00510',name=u'王一琛'); f4 = Password(user=u4,algorithm=u'MD5',credential=u'qwe123')
        u5 = User(role_id=115,user_name=u'00541',name=u'郝晶'); f5 = Password(user=u5,algorithm=u'MD5',credential=u'qwe123')
        u6 = User(role_id=116,user_name=u'00779',name=u'郭强'); f6 = Password(user=u6,algorithm=u'MD5',credential=u'qwe123')
        u7 = User(role_id=117,user_name=u'00513',name=u'陈芳'); f7 = Password(user=u7,algorithm=u'MD5',credential=u'qwe123')
        u8 = User(role_id=118,user_name=u'00136',name=u'井清泉'); f8 = Password(user=u8,algorithm=u'MD5',credential=u'qwe123')

        self.session.add_all([f1,f2,f3,f4,f5,f6,f7,f8])

        u11 = User(role_id=121,user_name=u'00149',name=u'苗小梅'); f11 = Password(user=u11,algorithm=u'MD5',credential=u'qwe123')
        u12 = User(role_id=122,user_name=u'00335',name=u'宋文'); f12 = Password(user=u12,algorithm=u'MD5',credential=u'qwe123')
        u13 = User(role_id=123,user_name=u'91014',name=u'陈续红'); f13 = Password(user=u13,algorithm=u'MD5',credential=u'qwe123')
        u14 = User(role_id=124,user_name=u'00477',name=u'郑茂萍'); f14 = Password(user=u14,algorithm=u'MD5',credential=u'qwe123')
        u15 = User(role_id=125,user_name=u'00005',name=u'魏霞'); f15 = Password(user=u15,algorithm=u'MD5',credential=u'qwe123')
        u16 = User(role_id=126,user_name=u'00003',name=u'王广智'); f16 = Password(user=u16,algorithm=u'MD5',credential=u'qwe123')
        u17 = User(role_id=127,user_name=u'00009',name=u'何玉娥'); f17 = Password(user=u17,algorithm=u'MD5',credential=u'qwe123')
        u18 = User(role_id=128,user_name=u'00002',name=u'崔洪杰'); f18 = Password(user=u18,algorithm=u'MD5',credential=u'qwe123')

        self.session.add_all([f11,f12,f13,f14,f15,f16,f17,f18])

        u21 = User(role_id=131,user_name=u'01000'); f21 = Password(user=u21,algorithm=u'MD5',credential=u'qwe123')
        u22 = User(role_id=132,user_name=u'01001'); f22 = Password(user=u22,algorithm=u'MD5',credential=u'qwe123')
        u23 = User(role_id=133,user_name=u'01002'); f23 = Password(user=u23,algorithm=u'MD5',credential=u'qwe123')
        u24 = User(role_id=134,user_name=u'01003'); f24 = Password(user=u24,algorithm=u'MD5',credential=u'qwe123')
        u25 = User(role_id=135,user_name=u'01004'); f25 = Password(user=u25,algorithm=u'MD5',credential=u'qwe123')
        u26 = User(role_id=136,user_name=u'01005'); f26 = Password(user=u26,algorithm=u'MD5',credential=u'qwe123')
        u27 = User(role_id=137,user_name=u'01006'); f27 = Password(user=u27,algorithm=u'MD5',credential=u'qwe123')
        u28 = User(role_id=138,user_name=u'01007'); f28 = Password(user=u28,algorithm=u'MD5',credential=u'qwe123')
        u29 = User(role_id=139,user_name=u'01008'); f29 = Password(user=u29,algorithm=u'MD5',credential=u'qwe123')
        u30 = User(role_id=140,user_name=u'01009'); f30 = Password(user=u30,algorithm=u'MD5',credential=u'qwe123')
        self.session.add_all([f21,f22,f23,f24,f25,f26,f27,f28,f29,f30])
    ...
    def init_customer(self):
        ...
        party_role = PartyRole(party=man,role_id=user.role_id)
        ...
        party_role = PartyRole(party=company,role_id=user.role_id)
        self.session.add(party_role)
    ...
    def init_product(self):
        ...
        self.session.add_all([
            ...
            #Product(main_gua_type="抵押", product_code="111", product_type=pt01, name="商用门脸店按揭贷款",product_page='loanBaseInfo'),
           ...
           # Product(main_gua_type="保证", product_code="122", product_type=pt02, name="汽车个人消费贷款",product_page='car_consume'),
           # Product(main_gua_type="保证", product_code="118", product_type=pt02, name="装饰装修个人消费贷款",product_page='personal_housing_decoration'),
            #Product(main_gua_type="保证", product_code="119", product_type=pt02, name="旅游个人消费贷款",product_page='loanBaseInfo'),
            #Product(main_gua_type="保证", product_code="121", product_type=pt02, name="耐用品个人消费贷款",product_page='loanBaseInfo'),
            #Product(main_gua_type="保证", product_code="225", product_type=pt02, name="狮卡授信消费贷款",product_page='loanBaseInfo'),
            ...
            #Product(main_gua_type="质押", product_code="110", product_type=pt04, name="其他有价单证质押贷款",product_page='loanBaseInfo'),
            ...
            #Product(main_gua_type="保证", product_code="379", product_type=pt04, name="保证担保贷款",product_page='loanBaseInfo'),
            ...
            #Product(main_gua_type="抵押", product_code="368_1", product_type=pt11, name="异地商房抵押60",product_page='loanBaseInfo'),
            ...
            #Product(main_gua_type="保证", product_code="374", product_type=pt11, name="企业信用既保证",product_page='loanBaseInfo'),
            ...
            #Product(main_gua_type="#", product_code="150", product_type=pt51, name="对私贷款展期",product_page='loanBaseInfo'),
            #Product(main_gua_type="#", product_code="140", product_type=pt51, name="对私授信额度调整",product_page='loanBaseInfo'),
