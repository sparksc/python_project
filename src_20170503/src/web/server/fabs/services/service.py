# -*- coding: utf-8 -*-
"""
    yinsho.services.BaseService
    #####################

    yinsho BaseService module
"""
#from yinsho.base.extensions import db
import datetime
import copy
...
class BaseService(object):
    """A :class:`BaseService` instance encapsulates common SQLAlchemy model
    ...
    def paginate(self,**kwargs):
        ...
        kwargs.pop('page')
        kwargs.pop('per_page')
        pagination = self.__model__.query.filter_by(**kwargs).paginate(args['page'],args['per_page'], False)
        result = {
    ...
    def now(self):
        """TODO: query for database sys_date"""
