...
def result_to_file_jigou_excel(flag, dList):
    ...
    ws.append(head)
    ws.append(dList[0])
    file_name = path + org_no + "_result_" + str(flag) + '.xlsx'
    ...
    while True:
        ...
        if new_org_no != org_no:   #更换机构号
            ...
            ws = wb.create_sheet()
            ws.append(head)
            file_name = path + new_org_no + "_result_" + str(flag) + '.xlsx'
...
def result_to_file_jigou_cust_no_excel(newDataList, newDataList1, newDataList2, newDataList3, newDataList5,cust_day_amt_dict_2015, cust_day_amt_dict_2016, cust_amt_dict):
    ...
    #wb = Workbook(write_only = True)
    #ws = wb.create_sheet()
    head = [u"网点号",u"客户号",u"客户内码",u"客户名称",u"2015年日均",u"2016年日均",u"余额",u"比例",u"核心地址",u"信贷地址",u"电话",u"挂钩生效日期",u"信贷经办人员",u"信贷经办人员姓名", u"原分配客户经理", u"错误原因", u"认定柜员号",u"认定人姓名"]
    ws.append(head)
    ...
    ws.append(excelList)
    file_name_u = path + org_no + u'_对私客户认定.xlsx'
    ...
    while True:
        ...
        if new_org_no != org_no:   #更换机构号
            ...
            #ws = wb.create_sheet()
            ws.append(head)
            file_name_u = path + new_org_no + u'_对私客户认定.xlsx'
            file_name = file_name_u.encode('gbk')
        ...
        if new_cus_no != cus_no:   #更换客户编号
            ...
            for tdl in tempDataList:
                ...
                if new_jigou != jigou:   #更换机构
                    ...
                    day_amt_2015_sum = day_amt_2015
                else:
                    day_amt_2015_sum = day_amt_2015_sum + day_amt_2015
                jigou = new_jigou
        ...
        if new_cus_no != cus_no:   #更换客户编号
            ...
            for tdl in tempDataList:
                ...
                if new_jigou != jigou:   #更换机构
                    ...
                    day_amt_2016_sum = day_amt_2016
                else:
                    day_amt_2016_sum = day_amt_2016_sum + day_amt_2016
                jigou = new_jigou
...
def test_init_mx20160511_manager_relation_full_file2():
    ...
    result_to_file_jigou(4, newDataList4)
