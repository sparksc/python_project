...
from etl.star.model.core_affmspts import Core_Affmspts 
...
class Affmspts():
    def __init__(self):
        self.table_desc = util.get_table_desc("F_CORE_AFFMSPTS")
        
    def files2fact(self,ds,q1,q2):
        d0 = datetime.now()
        insertsql = ds.insert_sql()
        idx = 0 
        d1=datetime.now()
    ...
    def loadtofact(self,q1,q2):
        info("即期结售汇买卖明细文件")
        self.files2fact(Core_Affmspts(),q1,q2)#
