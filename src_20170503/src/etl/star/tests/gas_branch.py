...
from etl.star.model.gas_branch import Gas_branch
...
class GAS_BRANCH():
    def __init__(self):
        self.table_desc = util.get_table_desc("GAS_BIDW_ORG_LV6_DA")
    ...
    def loadtofact(self,q1,q2):
        info("人民币贷记卡账户")
        self.files2fact(Gas_branch(),q1,q2)#
