...
def run_import(filename,org_no=None,subtype=None):
    ...
    rd=[]
    indexdict={
        '企业网银':['cust',2,25,24,0,-1],
        'ETC':['cust',3,12,11,1,-1],
        'ETC2015':['cust',3,9,8,1,-1],
        'ETC2016':['cust',3,8,9,1,-1],
    }
    ...
    for r in range(1,nrows):
        ...
        #typelist=util.get_ebank_busi_type(ORG_NO,CUST_IN_NO)
        #if typelist:
        #    for tt in typelist:
        #        SUB_TYP=str(tt[0])
        #        if SUB_TYP==subtype:
