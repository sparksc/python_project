...
from etl.star.model.ccrdacct import CcrdAcct 
...
class CCRDACCT():
    def __init__(self):
        self.table_desc = util.get_table_desc("D_CREDIT_CARD")
    ...
    def loadtofact(self,q1,q2):
        info("人民币贷记卡账户")
        self.files2fact(CcrdAcct(),q1,q2)#
