...
from etl.star.model.dev_base_info import Devbaseinfo 
...
class Terminal():
            ...
            if q1 is None :
                ...
                if r is not None:
                    ...
                    if len(rs)>1000:
                        ...
                        pass
        for r in ds.contract_fact.values():
            rs.append(r)
            if len(rs)>1000:
                for ir in rs:
                    qwork.put( ( insertsql ,ir) )
    ...
    def loadtofact(self,q1,q2):
        info("自助终端")
        self.files2fact(Devbaseinfo(),q1,q2)#
