...
from etl.star.model.cust_addr_info import CustAddrUpdate 
from etl.star.model.cust_tel_info import CustTelUpdate 
...
class Custupdate():
    ...
    def loadtofact(self,q1,q2):
        info("信贷地址&电话更新")
        self.files2fact(CustAddrUpdate(),q1,q2)#
        self.files2fact(CustTelUpdate(),q1,q2)#
...
if __name__=='__main__':
    ...
    if arglen != 3:
        ...
        while etldate<=int(enddate):    
            ...
            CustInfoUpdate().loadtofact(None,None)
